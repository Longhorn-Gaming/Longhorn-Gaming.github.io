 ...
 */ !(function (t) {
    ...
    function (t, e, n) {
        ...
        (r.env.safari = /safari/.test(g) && !T && !m),
            I &&
    ...
    function (t, e, n) {
        ...
        var i = r(n(27)),
            ...
            R = o.IX2EngineItemTypes,
            w = R.GENERAL_START_ACTION,
            N = (R.GENERAL_CONTINUOUS_ACTION, o.IX2VanillaUtils.reifyState);
    ...
    function (t, e, n) {
        ...
        function st(t, e) {
            ...
            n ? mt({ store: e, actionListId: n }) : Tt({ store: e }), dt(e);
        }
        function ft(t, e) {
        ...
        function dt(t) {
            ...
            e.active &&
                (e.eventListeners.forEach(pt),
                t.dispatch((0, I.sessionStopped)()));
        }
        function pt(t) {
            var e = t.target,
                n = t.listenerParams;
        ...
        function Et(t) {
            ...
            if (i !== n.viewportWidth) {
                ...
                t.dispatch(
                    (0, I.viewportWidthChanged)({ width: i, mediaQueries: o })
                );
            }
        }
        var ht = function (t, e) {
            ...
            if (f && f.useFirstGroupAsInitialState) {
                ...
                l.forEach(function (t) {
                    ...
                    a.forEach(function (i) {
                        ...
                        Ot({
                            destination: G(
                                { element: i, actionItem: t, elementApi: T },
                                a
                            ),
                            immediate: !0,
                            store: e,
        ...
        function yt(t) {
            ...
            var m =
                    (0 === u || (1 === u && I)) &&
                    ut(v.action && v.action.actionTypeId)
                        ? v.config.delay
                        : void 0,
                y = (0, s.default)(g, [u, "actionItems"], []);
            if (!y.length) return !1;
            if (!K(h, p.mediaQueryKey)) return !1;
            var O = p.hasBoundaryNodes && r ? T.getClosestElement(r, R) : null,
                A = k(y),
                S = !1;
            return (
    ...
    function (t, e, n) {
        ...
        t.exports = function (t, e, n, h, _, g) {
            ...
            if (S && !O)
                return (
                    g || (g = new r()),
                    I || f(t) ? i(t, e, n, h, _, g) : o(t, e, m, n, h, _, g)
                );
            if (!(n & l)) {
                var b = O && E.call(t, "__wrapped__"),
                    R = A && E.call(e, "__wrapped__");
                if (b || R) {
                    var w = b ? t.value() : t,
                        N = R ? e.value() : e;
    ...
    function (t, e, n) {
                ...
                switch (i) {
                    ...
                    case T.STYLE_TEXT_COLOR:
                        var A = n.config,
                            ...
                            R = A.bValue,
                            w = A.aValue;
                        return { rValue: S, gValue: b, bValue: R, aValue: w };
                    case T.STYLE_FILTER:
                        ...
                        return (function (t, e, n) {
                            ...
                            switch (e.actionTypeId) {
                                case T.GENERAL_DISPLAY:
                                    ...
                                    return void (i === g.FLEX &&
                                    m.IS_BROWSER_ENV
                                        ? r(t, g.DISPLAY, m.FLEX_PREFIXED)
                                        : r(t, g.DISPLAY, i));
                            }
                        })(t, i, a);
        ...
        var f = s(n(193)),
            ...
            A = Object.freeze(
                ((i = {}),
                (0, c.default)(i, m.TRANSFORM_PREFIXED, g.TRANSFORM),
        ...
        function C(t) {
            ...
            var w,
                ...
                L,
                x =
                    (0, p.default)(n, "action.config.affectedElements", {})[
                        _ || y
                    ] || {},
            ...
            if (
                (D
                    ? ((w = x.limitAffectedElements), (C = P), (L = u(x)))
                    : (C = L = u({ id: _, selector: y, selectorGuids: O })),
                n && b)
            ) {
                var M = r && (L || !0 === b) ? [r] : c(P);
                if (L) {
                    ...
                    if (a) {
                        ...
                        -1 === u.indexOf(r) &&
                            o(
                                t,
                                g.WILL_CHANGE,
                                u.concat(r).join(g.COMMA_DELIMITER)
                            );
            ...
            switch (e.type) {
                ...
                case l:
                    var I = e.payload,
                        T = I.stateKey,
                        m = I.newState;
                    return (0, i.setIn)(t, ["eventState", T], m);
                case p:
                    var y = e.payload,
                        O = y.actionListId,
                        A = y.isPlaying;
            ...
            y = function (t, e) {
                ...
                if (r && o) {
                    ...
                    if (s) {
                        var S = O - a,
                            b = m + y,
                            R = p(Math.min(Math.max(0, S / b), 1));
                        t = (0, i.set)(t, "verboseTimeElapsed", b * R);
                    }
                    if (A < 0) return t;
                    var w = p(Math.min(Math.max(0, A / m), 1)),
                        N = v(I, w, g),
                        C = {},
                        L = null;
                    return (
            ...
            function O() {
                ...
                if (((s = arguments), (f = this), (v = t), n)) {
                    if (void 0 === p)
                        return (function (t) {
                            return (
                                (E = t), (p = setTimeout(m, e)), h ? I(t) : d
                            );
                        })(v);
                    if (_) return clearTimeout(p), (p = setTimeout(m, e)), I(v);
                }
            ...
            It =
                ...
                (0, o.default)(r, H, {
                    ...
                    handler: function (t) {
                        ...
                        (a = i ? 1 - a : a),
                            e.dispatch((0, h.parameterChanged)(r, a));
                    },
                }),
                (0, o.default)(r, U, {
                    types: at,
                    handler: function (t) {
                        ...
                        if (d === z) {
                            ...
                            return (
                                A !== o.scrollPercent &&
                                    n.dispatch((0, h.parameterChanged)(v, A)),
                                { scrollPercent: A }
                            );
                        }
                        var S = q(i, v),
                            ...
                            w = (g ? O : 0) / 100;
                        (R = E ? R : 1 - R), (w = _ ? w : 1 - w);
                        var N = b.top + Math.min(b.height * R, l),
                            C = b.top + b.height * w - N,
                            L = Math.min(l + C, f),
            ...
            (t.exports = function (t, e) {
                ...
                function T(n, i) {
                    ...
                    c.attr("role", "menu"),
                        ...
                        l.toggle.attr("tabindex") ||
                            l.toggle.attr("tabindex", "0"),
                        _ ||
                            ((_ = "w-dropdown-toggle-" + n),
                            l.toggle.attr("id", _)),
                ...
                function A(e) {
                    if (!e.open) {
                        ...
                        u || s.on(d + p, e.outside),
                            e.hovering &&
                                !i &&
                                e.el.on("mouseleave" + p, e.leave),
                            e.hovering &&
                                i &&
                                s.on("mousemove" + p, e.moveOutside),
    ...
    function (t, e, n) {
        ...
        r.define(
            ...
            (t.exports = function (t, e) {
                ...
                function b(t) {
                    t.overlay &&
                        (F(t, !0), t.overlay.remove(), (t.overlay = null));
                }
                function R(t) {
                    var n = {},
                        r = t.config || {},
                    ...
                    (n.animOver = /^over/.test(i)),
                        ...
                        r.animation !== i && t.open && e.defer(w, t),
                ...
                function P(t, e) {
                    if (!t.open) {
                        (t.open = !0),
                            t.menu.each(x),
                            t.links.addClass(I),
                            t.dropdowns.addClass(h),
                            t.dropdownToggle.addClass(_),
                            t.dropdownList.addClass(g),
                            t.button.addClass(E);
                        var n = t.config;
                        ("none" !== n.animation && s.support.transform) ||
                            (e = !0);
                        var i = M(t),
            ...
            (t.exports = function (t, e) {
                ...
                function A(n) {
                    return function (i, a) {
                        ...
                        if (o && "setting" === i.type) {
                            ...
                            if ((I(n), R(n), null == a.select)) return;
                            !(function (n, r) {
                                var i = null;
                                r === n.slides.length && (E(), R(n)),
                ...
                function S(e, n) {
                    ...
                    var l = e.offsetX || 0,
                        ...
                        O = "transform " + T + "ms " + I;
                    if (
                        (o || (E.each(v.intro), _.each(v.outro)),
                        n.immediate && !u)
                    )
                        return s(E).set(p), void b();
                    ...
                    if (u !== e.current) {
                        (e.current = u),
                            e.links.each(function (e, n) {
                                var r = t(n);
                                n.getAttribute(l) === u
                                    ? r.addClass(p).each(E.intro)
                                    : r.hasClass(p) &&
                                      r.removeClass(p).each(E.outro);
                            });
                        var c = [],
                            f = [];
                        e.panes.each(function (e, n) {
                            ...
                            n.getAttribute(l) === u
                                ? c.push(n)
                                : r.hasClass(v) && f.push(n);
                        });
                        var d = t(c),
                            _ = t(f);
                        if (n.immediate || i.immediate)
                            return (
                                d.addClass(v).each(E.intro),
                                _.removeClass(v),
                                void (h || r.redraw.up())
                            );
                        _.length && i.outro
...
Webflow.require("ix2").init({
    events: {
        e: {
            ...
            target: {
                ...
                originalId:
                    "5dfa93678d14132f526ff486|df538c65-0d14-a6b9-6736-dc908fac464b",
                appliesTo: "CLASS",
            },
            config: {
                loop: false,
        ...
        "e-3": {
            ...
            target: {
                ...
                originalId:
                    "5dfa93678d14132f526ff486|b47fdbb6-ab1b-3acb-afae-0dceb9b0a1e0",
                appliesTo: "CLASS",
            },
            config: {
                loop: false,
        ...
        "e-5": {
            ...
            target: {
                selector: ".advantages",
                originalId:
                    "5dfa93678d14132f526ff486|b47fdbb6-ab1b-3acb-afae-0dceb9b0a1f0",
                appliesTo: "CLASS",
            },
            config: {
                loop: false,
        ...
        "e-7": {
            ...
            target: {
                selector: ".post-item",
                originalId:
                    "5dfa93678d14132f526ff486|b47fdbb6-ab1b-3acb-afae-0dceb9b0a245",
                appliesTo: "CLASS",
            },
            config: {
                loop: false,
        ...
        "e-10": {
            ...
            target: {
                selector: ".three-blogs-div",
                originalId:
                    "5dfa93678d14132f526ff486|b47fdbb6-ab1b-3acb-afae-0dceb9b0a242",
                appliesTo: "CLASS",
            },
            config: {
                loop: false,
        ...
        "e-14": {
            ...
            mediaQueries: ["main", "medium"],
            target: {
                selector: ".three-services-div",
                originalId:
                    "5dfa93678d14132f526ff486|b47fdbb6-ab1b-3acb-afae-0dceb9b0a1dd",
                appliesTo: "CLASS",
            },
            config: {
                loop: false,
        ...
        "e-19": {
            ...
            mediaQueries: ["main", "medium", "small", "tiny"],
            target: {
                selector: ".team-4-item",
                originalId:
                    "5dfa93678d14137e9d6ff488|f60ff7ca-3bf6-8521-a1f5-aa5cc2790f15",
                appliesTo: "CLASS",
            },
            config: {
                loop: false,
        ...
        "e-21": {
            ...
            target: {
                ...
                originalId:
                    "5dfa93678d141304a56ff489|3d10c5d6-925f-f560-8c9d-f7e85dea32f4",
                appliesTo: "CLASS",
            },
            config: {
                loop: false,
    ...
    actionLists: {
        a: {
                    ...
                    actionItems: [
                        {
                            ...
                            config: {
                                ...
                                target: {
                                    ...
                                    selectorGuids: [
                                        "a9bef920-8f5d-b638-dc29-01ed39195954",
                                    ],
                                },
                                xValue: 0,
                                xUnit: "PX",
                        ...
                        },
                        {
                            ...
                            config: {
                                ...
                                target: {
                                    useEventTarget: "CHILDREN",
                                    selector: ".footer-link-image",
                                    selectorGuids: [
                                        "a9bef920-8f5d-b638-dc29-01ed39195946",
                                    ],
                                },
                                xValue: 0,
                                xUnit: "PX",
            ...
            createdOn: 1569850942023,
            useFirstGroupAsInitialState: true,
        },
        "a-2": {
            id: "a-2",
            title: "Footer Link Unhover",
            actionItemGroups: [
                {
                    actionItems: [
                        {
            ...
            createdOn: 1569850999946,
            useFirstGroupAsInitialState: false,
        },
        "a-9": {
            id: "a-9",
            title: "Service Box Hover",
            actionItemGroups: [
                {
                    actionItems: [
                        {
            ...
            createdOn: 1569867753531,
            useFirstGroupAsInitialState: true,
        },
        "a-5": {
            id: "a-5",
            title: "Advantages Image Animation",
            actionItemGroups: [
                {
                    actionItems: [
                        {
                            ...
                            config: {
                                ...
                                duration: 500,
                                target: {
                                    selector: ".advantages-image",
                                    selectorGuids: [
                                        "c45936b2-db5c-baa0-e7b3-8397bf2dc992",
                                    ],
                                },
                                xValue: -80,
                                xUnit: "PX",
            ...
            createdOn: 1570636905827,
            useFirstGroupAsInitialState: true,
        },
        "a-6": {
            id: "a-6",
            title: "Service Box Unhover",
            actionItemGroups: [
                {
                    actionItems: [
                        {
        ...
        "a-3": {
                    ...
                    actionItems: [
                        {
                            ...
                            config: {
                                ...
                                target: {
                                    ...
                                    selector: ".post-item",
                                    selectorGuids: [
                                        "c45936b2-db5c-baa0-e7b3-8397bf2dc973",
                                    ],
                                },
                                yValue: 0,
                                xUnit: "PX",
            ...
            createdOn: 1569868557329,
            useFirstGroupAsInitialState: true,
        },
        "a-8": {
            id: "a-8",
            title: "Three Blogs Animation",
            actionItemGroups: [
                {
                    actionItems: [
                        {
                            ...
                            config: {
                                ...
                                target: {
                                    useEventTarget: "CHILDREN",
                                    selector: ".blog-wrapper.small.two",
                                    selectorGuids: [
                                        "c45936b2-db5c-baa0-e7b3-8397bf2dc98d",
                                        "c45936b2-db5c-baa0-e7b3-8397bf2dc9a9",
                                        "c45936b2-db5c-baa0-e7b3-8397bf2dc9ab",
                                    ],
                                },
                                yValue: -40,
                                xUnit: "PX",
                        ...
                        },
                        {
                            ...
                            config: {
                                ...
                                target: {
                                    useEventTarget: "CHILDREN",
                                    selector: ".blog-wrapper.small.three",
                                    selectorGuids: [
                                        "c45936b2-db5c-baa0-e7b3-8397bf2dc98d",
                                        "c45936b2-db5c-baa0-e7b3-8397bf2dc9a9",
                                        "c45936b2-db5c-baa0-e7b3-8397bf2dc9ad",
                                    ],
                                },
                                yValue: 40,
                                xUnit: "PX",
            ...
            createdOn: 1570635781158,
            useFirstGroupAsInitialState: true,
        },
        "a-7": {
            id: "a-7",
            title: "Blog Box Unhover",
            actionItemGroups: [
                {
                    actionItems: [
                        {
            ...
            createdOn: 1569868604429,
            useFirstGroupAsInitialState: false,
        },
        "a-4": {
            id: "a-4",
            title: "Three Services Animation",
            actionItemGroups: [
                {
                    actionItems: [
                        {
                            ...
                            config: {
                                ...
                                target: {
                                    useEventTarget: "CHILDREN",
                                    selector: ".service-wrapper.one",
                                    selectorGuids: [
                                        "c45936b2-db5c-baa0-e7b3-8397bf2dc98f",
                                        "c45936b2-db5c-baa0-e7b3-8397bf2dc9a5",
                                    ],
                                },
                                yValue: -30,
                                xUnit: "PX",
                        ...
                        },
                        {
                            ...
                            config: {
                                ...
                                target: {
                                    useEventTarget: "CHILDREN",
                                    selector: ".service-wrapper.three",
                                    selectorGuids: [
                                        "c45936b2-db5c-baa0-e7b3-8397bf2dc98f",
                                        "c45936b2-db5c-baa0-e7b3-8397bf2dc9a3",
                                    ],
                                },
                                yValue: 30,
                                xUnit: "PX",
        ...
        "a-11": {
            ...
            createdOn: 1569869829720,
            useFirstGroupAsInitialState: false,
        },
        "a-12": {
            id: "a-12",
            title: "Blog Box 2 Hover",
            actionItemGroups: [
                {
                    actionItems: [
                        {
            ...
            createdOn: 1569869033138,
            useFirstGroupAsInitialState: true,
        },
        "a-13": {
            id: "a-13",
            title: "Blog Box 2 Unhover",
            actionItemGroups: [
                {
                    actionItems: [
                        {
                            ...
                            actionItems: [
                                {
                                    ...
                                    config: {
                                        ...
                                        target: {
                                            id:
                                                "918703bb-1de7-de4b-2d01-30469d8ed437",
                                        },
                                        rValue: 0,
                                        gValue: 0,
                                        bValue: 0,
